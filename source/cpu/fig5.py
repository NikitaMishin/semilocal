...
REPEATS = 5
default_logger = Logger('fig5_log.txt')
build_logger = Logger('fig5_build_log.txt')
...
if __name__ == '__main__':
    ...
    if args.real_data:
        tests_pairs = [(7742, 9663), (33356, 39245), (74437, 91721), (124884, 134226)]
    else:
        tests_pairs = [(10000, 10000), (50000, 50000), (100000, 100000), (200000, 200000)]
