...
## run for figures 5
#
python3 fig5.py 6 Datasets/clean_real_dataset/ fig5_real.csv 5 True
python3 fig5.py 6 Datasets/synthethic_dataset/binary/ fig5_synthethic_2.csv 5 False
python3 fig5.py 6 Datasets/synthethic_dataset/5/ fig5_synthethic_5.csv 5 False
python3 fig5.py 6 Datasets/synthethic_dataset/26/ fig5_synthethic_26.csv 5 False
#
#
