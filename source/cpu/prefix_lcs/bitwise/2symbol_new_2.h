...
//            process_antidiagonal<Input, SymbolType>(0, diag_len + 1, m - 1 - diag_len, 0, bitset_left_strand_map,
//                                                    bitset_top_strand_map, a_reverse, b);
//
//        }
//
//        for (int k = 0; k < total_same_length_diag; k++) {
//            process_antidiagonal<Input, SymbolType>(0, m, 0, k, bitset_left_strand_map,
//                                                    bitset_top_strand_map, a_reverse, b);
//        }
//
...
//            process_antidiagonal<Input, SymbolType>(0, diag_len, 0, start_j, bitset_left_strand_map,
//                                                    bitset_top_strand_map, a_reverse, b);
//            start_j++;
//        }
//
