...
/**
 * Program that evaluates performance of sequential braid multiplication with memory optimization
 * @param argc
...
int main(int argc, char *argv[]) {
    ...
    distance_unit_monge_product::steady_ant::steady_ant_parallel_wrapper(p, q, product, map, 0);
